...
const byte encoder0pinB = 8;//B pin -> the digital pin 8

String tmp="";// save temporar values of hall values

const byte encoder0pinC = 3;//A pin -> the interrupt pin 1
const byte encoder0pinD = 9;//B pin -> the digital pin 9

int encoder0PinALast;
int encoder1PinALast;

int duration0(0);//the number of the pulses
boolean Direction0(true);//the rotation direction 

int duration1(0);//the number of the pulses
